...
export const KmHubView: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    {
      id: 'faq-qchang-flow',
      question: 'ระบบจองบริการลูกค้าสไตล์ Q-Chang ทำงานร่วมกับระบบหลังบ้านอย่างไร?',
      category: 'integration',
      answer: 'ระบบจองบริการสไตล์ Q-Chang Portal ทำหน้าที่เป็นหน้ารับงานจากฝั่งลูกค้า (Customer Portal):\n\n' +
              '1. เมื่อลูกค้าทำการกรอกข้อมูล เลือกพิกัดโซน และเลือกสาขาในหน้าแค็ตล็อกสำเร็จ\n' +
              '2. ระบบจะทำการสร้างเอกสารตั๋วจองติดตั้ง (QueueBooking) ส่งเข้ามายังคิวหลังบ้านในสถานะจัดเตรียมงาน (Pending Dispatch) ทันที\n' +
              '3. ทางฝ่ายหลังบ้านสามารถเข้าประเมินและจัดสรรทีมช่างที่เหมาะสมที่สุดตามเกณฑ์ Match Score (%) และกระจายงานเข้าหน้างานจริงใน KANNA และ STS ต่อไปตามลำดับ'
    }
  ];
  ...
  const systemNodes: SystemNode[] = [
    {
      id: 'e-ordering',
      title: 'E-ordering / Q-Chang',
      subtitle: 'Selling Tools & Catalog Portal',
      shortDesc: 'ระบบสั่งซื้อหน้าร้าน และเว็บจองบริการลูกค้าสไตล์ Q-Chang',
      icon: Layers,
      colorClass: 'bg-blue-50 text-blue-700',
      borderColorClass: 'border-blue-200 focus:border-blue-500',
      textColorClass: 'text-blue-800',
      details: [
        'รับคำสั่งซื้อสินค้าจากหน้าร้าน ไทวัสดุ/BnB Home และรับใบจองบริการโดยตรงจากหน้าแค็ตตาล็อก Q-Chang Portal',
        'บันทึกรายละเอียดความต้องการของลูกค้า ข้อมูลโซนพื้นที่ติดตั้ง และนัดหมายวันเวลาจัดสรรคิวงาน',
        'ส่งต่อเอกสารตั๋วใบงานจองติดตั้ง เข้าสู่ระบบ Installer Management (Core Engine) เพื่อคำนวณคะแนนจับคู่ทีมช่างคุณภาพ'
      ]
    },
    {
      id: 'installer-mgmt',
          ...
          <div className="v-panel p-5 bg-white space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
              ...
              <div className="p-4 rounded-xl border border-slate-100 hover:border-slate-200 bg-slate-50/30 transition-all space-y-2 col-span-1 md:col-span-2">
                <h4 className="font-bold text-slate-800 text-xs md:text-sm">5. ระบบจองบริการลูกค้า (Q-Chang style Portal)</h4>
                <p className="text-[11px] text-slate-500 leading-relaxed">
                  ไปที่เมนู **จองบริการ (Q-Chang style)** ➔ เลือกค้นหาหรือเลือกประเภทบริการติดตั้งที่ต้องการ ➔ กดปุ่ม "จองบริการ" เพื่อเข้าสู่หน้าจอ Wizard เลือกเพิ่มความต้องการบริการเสริม ใส่ข้อมูลและชื่อผู้ติดต่อ เลือกสาขาสังกัด ➔ เลือกวันเวลานัดหมาย และยืนยันชำระเงิน ➔ ข้อมูลการจองจะแปลงเป็นตั๋วคิวส่งตรงเข้าสู่ตารางคิวงานหลักเพื่อให้ระบบจับคู่ช่างต่อทันที
                </p>
              </div>
            </div>
          </div>
