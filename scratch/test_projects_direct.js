async function testProjectsDirect() {
  const payload = {
  ...
  console.log('🚀 Sending exact BuildFlow Lead Payload to https://buildflowx.online/api/projects...');
  try {
    const res = await fetch('https://buildflowx.online/api/projects', {
      method: 'POST',
      headers: {
